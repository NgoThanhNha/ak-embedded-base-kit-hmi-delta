...
/*----------------------------------------------------------------------------*
 *  Device name: HMI Delta DOP-107BV
 *----------------------------------------------------------------------------*/
static MB_DevRegStruct_t HMI_Delta_Register[] = {
	{ 0  , REG_VAL_DEFAULT, MODBUS_FUNCTION_READ_REGISTERS, 1, (const int8_t*)"bool", INT16U10, true , (const int8_t*)"Light 1 status"},
	{ 1  , REG_VAL_DEFAULT, MODBUS_FUNCTION_READ_REGISTERS, 1, (const int8_t*)"bool", INT16U10, true , (const int8_t*)"Light 2 status"   },
	{ 2  , REG_VAL_DEFAULT, MODBUS_FUNCTION_READ_REGISTERS, 1, (const int8_t*)"bool", INT16U10, true , (const int8_t*)"Light 3 status"   },
	{ 3  , REG_VAL_DEFAULT, MODBUS_FUNCTION_READ_REGISTERS, 1, (const int8_t*)"bool", INT16U10, true , (const int8_t*)"Light 4 status"   },
	{ 4  , REG_VAL_DEFAULT, MODBUS_FUNCTION_READ_REGISTERS, 1, (const int8_t*)"bool", INT16U10, true , (const int8_t*)"Motor status"   },
	{ 5  , REG_VAL_DEFAULT, MODBUS_FUNCTION_READ_REGISTERS, 1, (const int8_t*)"bool", INT16U10, true , (const int8_t*)"Pump status"   },
};

MB_DeviceStruct_t HMI_Delta = {
	.tId = 1,
	.tBaud = 9600,
	.listRegDevice = HMI_Delta_Register,
	.listRegAmount = sizeof(HMI_Delta_Register) / sizeof(HMI_Delta_Register[0])
};
